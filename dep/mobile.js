...
app.all('*', function(req, res, next) {
    ...
    res.header("Access-Control-Allow-Headers", "from, Authorization, Content-Type, X-Requested-With,Content-Length,Authorization,Accept,Cookie,Cache-Control,Pragma,expire-day");
...
proxy.on('proxyReq', function(proxyReq, req, res, options) {
    proxyReq.setHeader('from', 'client')
    proxyReq.setHeader('Accept', 'application/json')
    proxyReq.setHeader("Authorization", "Bearer 88099af661a8499fafc23d651cdb6636")
